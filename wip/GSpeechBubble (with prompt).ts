...
// const PROMPT_PADDING: number = 8;
// const PROMPT_WIDTH: number = 32;
// const PROMPT_HEIGHT: number = 30;
...
//     private forcedPromptLeft: boolean = false;
//     private promptImage: Phaser.GameObjects.Image;
//     private promptOn: boolean = false;

//     private startTime: number;
//     private wordsSpoken: number = 0;

//     constructor(speaker: GCharSprite, text: string) {
//         super(GFF.AdventureScene);
//         this.speaker = speaker;
//         GFF.AdventureScene.add.existing(this);
//         this.setDepth(9999);

//         // Create graphics object for the bubble shape:
//         this.bubbleGraphics = GFF.AdventureScene.add.graphics();
...
//         let promptX: number = this.forcedPromptLeft ? bubbleLoc.x - PROMPT_PADDING - PROMPT_WIDTH : bubbleLoc.x + bubbleWidth + PROMPT_PADDING;
//         let promptY: number = bubbleLoc.y + bubbleHeight - PROMPT_HEIGHT;
//         this.promptImage = GFF.AdventureScene.add.image(promptX, promptY, 'enter_keyprompt').setVisible(false).setOrigin(0, 0);
//         this.add(this.promptImage);
//     }
...
//         // Regardless of whether we adjusted the bubble, we need to determine whether
//         // or not the prompt needs to be forced to the left:
//         if (bubbleX + bubbleWidth + PROMPT_PADDING + PROMPT_WIDTH + SCREEN_EDGE_SPACE >= GFF.RIGHT_BOUND) {
//             this.forcedPromptLeft = true;
//         }
...
//     private startPrompt() {
//         GFF.AdventureScene.time.addEvent({
//             delay: 500,
//             callback: () => {
//                 this.promptImage.visible = !this.promptImage.visible;
//             },
//             loop: true
//         });
//         this.promptOn = true;
