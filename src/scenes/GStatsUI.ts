...
const INPUT_DEFAULT: GInputMode = new GInputMode('stats.default');

export class GStatsUI extends GUIScene {

    constructor() {
        super("StatsUI");

        this.setContainingMode(GFF.STATS_MODE);
    }
