...
export class GMenuRadioOption extends GMenuTextOption {
    ...
    private radioGroup: GMenuRadioGroup|null = null;
    ...
    constructor(scene: Phaser.Scene, x: number, y: number, text: string, boxColor: GColor, descriptionText: string, style: Phaser.Types.GameObjects.Text.TextStyle) {
        ...
        this.checkBox = scene.add.ellipse(
    ...
    public setRadioGroup(group: GMenuRadioGroup) {
