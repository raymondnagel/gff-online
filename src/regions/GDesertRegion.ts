...
const STOCK_REGIONS = [
    ...
    { name: 'Zin', adjective: 'Zinite' },
    { name: 'Negev', adjective: 'Negevite' },
    { name: 'Shur', adjective: 'Shurite' },
    { name: 'Arabah', adjective: 'Arabian' },
    { name: 'Tekoa', adjective: 'Tekoan' },
    { name: 'Kadesh', adjective: 'Kadeshite' },
    { name: 'Jeshimon', adjective: 'Jeshimonite' },
    { name: 'Tamar', adjective: 'Tamarite' },
    { name: 'Achor', adjective: 'Achorite' },
];
