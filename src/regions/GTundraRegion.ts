...
const STOCK_REGIONS = [
    ...
    { name: 'Bashan', adjective: 'Bashanite' },
    { name: 'Zarethan', adjective: 'Zarethanish' },
    { name: 'Gilead', adjective: 'Gileadite' },
    { name: 'Tishbe', adjective: 'Tishbite' },
    { name: 'Havothjair', adjective: 'Havothjairite' },
    { name: 'Jabbok', adjective: 'Jabbokite' },
    { name: 'Argob', adjective: 'Argobite' },
    { name: 'Mahanaim', adjective: 'Mahanaimite' },
    { name: 'Mizpeh', adjective: 'Mizpehite' },
    { name: 'Rehob', adjective: 'Rehobite' },
];
